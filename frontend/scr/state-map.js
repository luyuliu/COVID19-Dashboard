...
var state_plot_id = "#state_plot";

var maptype = 'geojson';

var state_map_width = $(state_map_id).width();
var state_map_height = $(state_map_id).height();
...
function ready(all_data) {
    ...
    state_timelines_svg = d3.select("#state_plot").append("svg")
